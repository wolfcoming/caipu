...
public class SelectAdapter2 extends BaseAdapter {
    List<ISelectAble2> datas;
    int selectedIndex = Selector.INDEX_INVALID;

    public SelectAdapter2(List<ISelectAble2> datas) {
        this.datas = datas;
    }
...
//    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ISelectAble2 item = (ISelectAble2) getItem(position);
