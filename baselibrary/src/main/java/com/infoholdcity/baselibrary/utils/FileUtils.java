...
public class FileUtils {
    ...
    public synchronized static void writeFileToSDCardAppend(@NonNull final String buffer, @NonNull final String folder,
                                                            @Nullable final String fileName) {
//         if(BuildConfig.DEBUG){
        writeFileToSDCard(buffer.getBytes(), folder, fileName, true, true);
//         }
    }

    public synchronized static void writeFileToSDCardAppend(@NonNull final byte[] buffer, @NonNull final String folder,
                                                            @Nullable final String fileName) {
//         if(BuildConfig.DEBUG){
            writeFileToSDCard(buffer, folder, fileName, true, true);
//         }
    }

    /*
       此方法为android程序写入sd文件文件
